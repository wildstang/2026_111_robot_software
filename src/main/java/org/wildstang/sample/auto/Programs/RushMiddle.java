...
import org.wildstang.sample.auto.Steps.AutoSuperStructureStep;
...
public class RushMiddle extends AutoProgram {
    ...
    protected void defineSteps(){
        ...
        group1.addStep(new AutoSuperStructureStep());
        group1.addStep(new SwerveToPointStep(swerve, new Pose2d(7.549369,1.968659,new Rotation2d(0.626978681967))));
