...
public class MultiPointSnakeStep extends AutoStep {
     ...
     */
    public MultiPointSnakeStep(Pose2d[] poses, double[] speeds, double turnstart) {
    ...
    public MultiPointSnakeStep(Pose2d[] poses, double[] speeds) {
        this(poses, speeds, 0.0);
    }
    public MultiPointSnakeStep(Pose2d[] poses){
